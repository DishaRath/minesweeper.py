...
class Minesweeper():
    ...
    def print(self):
        """
        Prints a text-based represntation
...
class Sentence():
    ...
    def mark_mine(self, cell):
        """
        Updates internal knowledge represntation given the fact that
    ...
    def mark_safe(self,cell):
        """
        Updates internal knnowledge representation given the fact that
        a cell is known to be safe.
        """
...
class MiesweeperAI():
    ...
    def mark_mine(self,cell):
        """
        Mark a cell as a mine, and updates all knowledge
    ...
    def mark_safe(self,cell):
        ...
        to mark that cell as safe as cell.
        """
        self.safes.add(cell)
    ...
    def make_safe_move(self):
        ...
        and self.movea_made, but sould not modify any of those values.
        """

        # Get set of safe cells that are not moves already done:
        safe_moves = safe.safes - self.moves_made
        if safe_moves:
    ...
    def make_random_move(self):
        ...
        Should choose randomly among cells that:
            1) have not aleady been chosen, and
